...
public class AssociationBtn extends JButton implements ButtonAction {
    public AssociationBtn(String buttonName) {
        super(buttonName);
    ...
    public void enterMode() {
        ...
        canvaArea.updateCurrentMode(Mode.ASSOCIATION);
    }
}
