...
public class GeneralizationBtn extends JButton implements ButtonAction {
    public GeneralizationBtn(String buttonName) {
        super(buttonName);
    ...
    public void enterMode() {
        ...
        canvaArea.updateCurrentMode(Mode.GENERALIZATION);
    }
}
