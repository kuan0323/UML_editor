...
public class CompositionBtn extends JButton implements ButtonAction {
    public CompositionBtn(String buttonName) {
        super(buttonName);
    ...
    public void enterMode() {
        ...
        canvaArea.updateCurrentMode(Mode.COMPOSITION);
    }
}
